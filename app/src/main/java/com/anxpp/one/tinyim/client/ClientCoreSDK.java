package com.anxpp.one.tinyim.client;
...
import com.anxpp.one.tinyim.client.core.AutoReLoginDaemon;
import com.anxpp.one.tinyim.client.core.KeepAliveDaemon;
import com.anxpp.one.tinyim.client.core.MessageReceiver;
import com.anxpp.one.tinyim.client.core.QoS4ReceiveDaemon;
import com.anxpp.one.tinyim.client.core.QoS4SendDaemon;
...
public class ClientCoreSDK {
    ...
    public void release() {
        ...
        // 尝试停掉消息接收者
        MessageReceiver.getInstance(context).stop();
