...
public class ExampleActivity extends AppCompatActivity implements FilterListener<Tag> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView.setAdapter(mAdapter = new ArticleAdapter(this, mAllArticles = getQuestions()));
    ...
    public void onNothingSelected() {
        if (mRecyclerView != null) {
            mAdapter.setArticles(mAllArticles);
            mAdapter.notifyDataSetChanged();
        }
    }

    private List<Article> getQuestions() {
        return new ArrayList<Article>() {{
            add(new Article("Carol Bell", "Graphic Designer",
            ...
            add(new Article("Melissa Morales", "Project Manager",
            ...
            add(new Article("Rochelle Yingst", "iOS Developer",
    ...
    public void onFiltersSelected(@NotNull ArrayList<Tag> filters) {
        ...
        List<Article> oldArticles = mAdapter.getArticles();
